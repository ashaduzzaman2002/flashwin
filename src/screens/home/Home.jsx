        ...
        <div className="home-container">
          <div className="home-top">
            ...
            <div className="balance__section">
              ...
              <div className="balance__section__right">
                <div className="balance__section__right__inner">
                  <button onClick={() => naivgate('/recharge')} className="balance__section__recharge__btn">
                    Recharge
                  </button>{' '}
                  <br />
                  <button
            ...
            <div className="balance__section__bottom">
              <div onClick={() => naivgate('/rewards')} className="balance__section__bottom__cols">
              ...
              <div onClick={() => naivgate('/check-in')} className="balance__section__bottom__cols">
                <div className="balance__section__bottom__icon">
                  <img
