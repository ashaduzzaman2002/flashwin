        ...
        <div className="home-container">
          <div className="home-top">
            ...
            <div class="balance__section">
              <div class="balance__section__left">
                <div class="balance__section__text">My Balance</div>
                <div class="balance__value">
                  <span style={{ fontSize: 18 }}>₹</span>548.48
                </div>
              </div>
              <div class="balance__section__right">
                <div class="balance__section__right__inner">
                  <button onClick={() => naivgate('/recharge')} class="balance__section__recharge__btn">
                    Recharge
                  </button>{' '}
                  <br />
                  <button
                  onClick={() => naivgate('/withdraw')}
                    class="balance__section__withdrawal__btn"
                    style={{ marginTop: 5 }}
                  >
                    Withdrawal
                  </button>
            ...
            <div class="balance__section__bottom">
              <div onClick={() => naivgate('/rewards')} class="balance__section__bottom__cols">
                <div class="balance__section__bottom__icon">
                  <img
                ...
                <div class="balance__section__bottom__cols__name">
                  Rewards
                </div>
              </div>
              <div onClick={() => naivgate('/check-in')} class="balance__section__bottom__cols">
                <div class="balance__section__bottom__icon">
                  <img
                ...
                <div class="balance__section__bottom__cols__name">Check In</div>
              </div>
            </div>
